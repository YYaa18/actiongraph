    ...
    public static ActionGraphComponentCatalog create() {
        List<ActionGraphComponent> components = list(
                ...
                component("actiongraph-core", ComponentKind.CORE,
                        "Core GOAP runtime with Action SPI, annotation adapter, planner, executor, policy, trace, SLF4J API diagnostics, compensation, suspend/resume, goal interpretation contracts, runtime entry service, and structured memory contracts.",
                        ComponentCompatibility.JAVA21_PLUS,
                        list("action-spi", "annotation-actions", "reflection-adapter",
                                "planning", "execution", "policy", "trace", "slf4j-api-diagnostics", "suspend-resume",
