...
public class ActionGraphHumanReviewApiProperties implements SharedSecretTokenProperties {
    ...
    public void setPath(String path) {
        if (path == null || path.isBlank()) {
            throw new IllegalArgumentException("human review API path must not be blank");
        }
        this.path = path;
    }
    ...
    public void setTokenHeader(String tokenHeader) {
        if (tokenHeader == null || tokenHeader.isBlank()) {
            throw new IllegalArgumentException("human review API token header must not be blank");
        }
    ...
    public void setSharedSecret(String sharedSecret) {
        if (sharedSecret != null && sharedSecret.isBlank()) {
            throw new IllegalArgumentException("human review API shared secret must not be blank");
        }
