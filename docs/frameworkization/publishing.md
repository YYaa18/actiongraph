...
| `actiongraph-control-plane-api` | `com.actiongraph:actiongraph-control-plane-api:0.1.0` | Java 8 compatible control-plane contracts, lightweight Runtime and Component Catalog HTTP clients, and shared-secret token verification |
