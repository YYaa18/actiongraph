    ...
    public static ActionGraphComponentCatalog create() {
        List<ActionGraphComponent> components = list(
                ...
                component("actiongraph-core", ComponentKind.CORE,
                        "Core GOAP runtime with Action SPI, annotation adapter, planner, executor, policy, trace, observability SPI, SLF4J API diagnostics, compensation, suspend/resume, goal interpretation contracts, runtime entry service, and structured memory contracts.",
                        ComponentCompatibility.JAVA21_PLUS,
                        list("action-spi", "annotation-actions", "reflection-adapter",
                                "planning", "execution", "policy", "trace", "observability-spi",
                                "slf4j-api-diagnostics", "suspend-resume",
                ...
                component("actiongraph-spring-boot-starter", ComponentKind.FRAMEWORK,
                        "Primary Spring Boot starter for annotation scanning, runtime defaults, optional LLM client wiring, optional Micrometer observations, JDBC repositories, structured memory, repository-backed human review, governance, and optional runtime/catalog/review/console endpoints.",
                        ComponentCompatibility.JAVA21_PLUS,
                        ...
                        list("actiongraph-core", "actiongraph-console",
                                "actiongraph-control-plane-api",
                                "actiongraph-governance",
                                "actiongraph-human-review", "actiongraph-llm-deepseek",
                ...
                component("actiongraph-control-plane-api", ComponentKind.CONTROL_PLANE,
                        "Java 8 compatible component catalog, control-plane contracts, runtime gateway interface, properties-based aggregate configuration, safe GET retries, aggregate/runtime/catalog/human-review/console HTTP clients, audit header forwarding, and shared-secret token verification.",
        ...
        List<ActionGraphCompositionProfile> profiles = list(
                ...
                profile("control-plane-response-contracts",
                        "Java 8 compatible response DTOs, runtime gateway interface, properties-based aggregate configuration, safe GET retries, aggregate/runtime/catalog/human-review/console HTTP clients, and token verification for legacy adapters.",
                        ...
                        list("Spring endpoint controllers use this module to keep error response JSON and shared-secret semantics consistent.",
                                ...
                                "Java 8 applications can depend on ActionGraphRuntimeGateway and use ActionGraphRuntimeHttpClient to call a deployed runtime API without Spring or third-party dependencies.",
