    ...
    public static ActionGraphComponentCatalog create() {
        List<ActionGraphComponent> components = list(
                ...
                component("actiongraph-persistence-jdbc", ComponentKind.INFRASTRUCTURE,
                        ...
                        list("actiongraph-spring-boot-starter", "actiongraph-console-spring-boot-starter")),
                component("actiongraph-spring-boot-starter", ComponentKind.FRAMEWORK,
                        "Primary Spring Boot starter for annotation scanning, runtime defaults, JDBC repositories, structured memory, repository-backed human review, governance, and optional control-plane endpoints.",
                        ComponentCompatibility.JAVA21_PLUS,
                        ...
                        list("actiongraph-core", "actiongraph-annotations", "actiongraph-control-plane-api",
                                "actiongraph-governance",
                                "actiongraph-human-review", "actiongraph-persistence-jdbc"),
                        list("actiongraph-console-spring-boot-starter", "actiongraph-llm-deepseek")),
                ...
                component("actiongraph-console-spring-boot-starter", ComponentKind.CONTROL_PLANE,
                        "Optional Spring Boot Console API, UI, export endpoints, shared service auto-configuration, and JDBC read-model repository auto-configuration.",
                        ComponentCompatibility.JAVA21_PLUS,
                ...
                component("actiongraph-control-plane-api", ComponentKind.CONTROL_PLANE,
                        ...
                        list(), list("actiongraph-spring-boot-starter", "actiongraph-console-spring-boot-starter")),
        ...
        List<ActionGraphCompositionProfile> profiles = list(
                ...
                profile("console-control-plane",
                        ...
                        list("The Console starter exposes API, UI, export endpoints, and optional JDBC read-model repository wiring behind actiongraph.console.* gates.")),
