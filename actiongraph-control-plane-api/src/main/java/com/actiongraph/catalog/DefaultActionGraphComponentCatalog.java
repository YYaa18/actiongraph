    ...
    public static ActionGraphComponentCatalog create() {
        List<ActionGraphComponent> components = list(
                ...
                component("actiongraph-spring-boot-starter", ComponentKind.FRAMEWORK,
                        "Primary Spring Boot starter for annotation scanning, runtime defaults, optional Micrometer observations, JDBC repositories, structured memory, repository-backed human review, governance, and optional runtime/catalog/review/console endpoints.",
                        ComponentCompatibility.JAVA21_PLUS,
