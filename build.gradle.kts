...
val libraryModuleDescriptions = mapOf(
    ...
    "actiongraph-control-plane-api" to "Java 8 compatible control-plane contracts, properties-based aggregate configuration, lightweight aggregate and split HTTP clients, and shared-secret token verification.",
