...
- Java 8 compatible control-plane contracts plus properties-based aggregate configuration and lightweight aggregate, runtime, component catalog, human-review, and console HTTP clients
...
| `actiongraph-control-plane-api` | Java 8 compatible control-plane response contracts, properties-based aggregate configuration, lightweight aggregate / Runtime / Component Catalog / Human Review / Console HTTP clients, and shared-secret token verification |
