...
| `actiongraph-control-plane-api` | `com.actiongraph:actiongraph-control-plane-api:0.1.0` | Java 8 compatible control-plane contracts, lightweight Runtime, Component Catalog, Human Review, and Console HTTP clients, and shared-secret token verification |
...
Control-plane response contracts, lightweight Runtime, Component Catalog, Human Review, and Console HTTP clients, and shared-secret token verification add:
