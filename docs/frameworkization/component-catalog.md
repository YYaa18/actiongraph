...
- the documented raw HTTP gateway contract reference can be consumed from standalone `javac --release 8` source with an empty classpath and no ActionGraph imports
