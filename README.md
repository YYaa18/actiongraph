...
- Java 8 compatible control-plane contracts plus lightweight runtime, component catalog, human-review, and console HTTP clients
...
| `actiongraph-control-plane-api` | Java 8 compatible control-plane response contracts, lightweight Runtime, Component Catalog, Human Review, and Console HTTP clients, and shared-secret token verification |
