...
- Java 8 compatible control-plane contracts plus lightweight aggregate, runtime, component catalog, human-review, and console HTTP clients
...
| `actiongraph-control-plane-api` | Java 8 compatible control-plane response contracts, lightweight aggregate / Runtime / Component Catalog / Human Review / Console HTTP clients, and shared-secret token verification |
